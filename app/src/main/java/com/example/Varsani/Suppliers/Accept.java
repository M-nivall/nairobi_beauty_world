...
public class Accept extends AppCompatActivity {
    private TextView txv_requestID,txv_items,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txv_items.setText("Item: "+in.getStringExtra("item"));
        ...
        if (product.equals("Aqua Water")) {
            unitprice = 1000;
            txt_unitprice.setText("Price per Litre: ksh: " + unitprice);
            totalcharge = unitprice * quantity;
            edt_amount.setText("Total Amount: ksh: " + totalcharge);
            txt_quantity.setText("Quantity: " + quantity + " Litres");
        }
        if (product.equals("Coconut Oil")) {
            unitprice = 2000;
            txt_unitprice.setText("Price per Litre: ksh: " + unitprice);
            totalcharge = unitprice * quantity;
            edt_amount.setText("Total Amount: ksh: " + totalcharge);
        ...
        if (product.equals("Cetyl Alcohol")) {
            unitprice = 2500;
            txt_unitprice.setText("Price per Litre: ksh: " + unitprice);
            totalcharge = unitprice * quantity;
            edt_amount.setText("Total Amount: ksh: " + totalcharge);
        ...
        if (product.equals("Phenoxyethanol")) {
            unitprice = 800;
            txt_unitprice.setText("Price per Litre: ksh: " + unitprice);
            totalcharge = unitprice * quantity;
            edt_amount.setText("Total Amount: ksh: " + totalcharge);
        ...
        if (product.equals("Potassium Sorbate")) {
            unitprice = 1200;
            txt_unitprice.setText("Price per Litre: ksh: " + unitprice);
            totalcharge = unitprice * quantity;
            edt_amount.setText("Total Amount: ksh: " + totalcharge);
