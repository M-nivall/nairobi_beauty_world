...
import static com.example.Varsani.utils.Urls.URL_SUBMIT_ASSIGNMENT;
...
public class SubmitAssignment extends AppCompatActivity {
    ...
    private void uploadPDF(final String pdfname, Uri pdffile) {
        ...
        try {
            ...
            VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, URL_SUBMIT_ASSIGNMENT,
                    response -> {
...
//                                startActivity(in);
            ...
            rQueue = Volley.newRequestQueue(SubmitAssignment.this);
