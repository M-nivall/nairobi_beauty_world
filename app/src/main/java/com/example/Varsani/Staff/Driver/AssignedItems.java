...
public class AssignedItems extends AppCompatActivity {
    ...
    private TextView txv_name,txv_orderID,txv_orderStatus, txv_address,txv_town, txv_county,
            txv_shippingCost, txv_orderCost, txv_totalAmount;
...
//        edt_driver.setEnabled(false);
        ...
        txv_orderCost.setText("Item Cost: " + orderCost );
