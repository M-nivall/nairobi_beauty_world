...
//    }
    ...
    public AdapterQuot(Context context, List<BookingModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterQuot.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterQuot.OriginalViewHolder) {
            final AdapterQuot.OriginalViewHolder view = (AdapterQuot.OriginalViewHolder) holder;
