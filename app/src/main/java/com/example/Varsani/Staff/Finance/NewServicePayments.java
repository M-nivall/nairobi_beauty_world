...
import com.example.Varsani.Staff.Adapters.AdapterBookings;
...
public class NewServicePayments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("New Payments");
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    String course=jsn.getString("course");
                                    String studyMode=jsn.getString("studyMode");
                                    String fee=jsn.getString("fee");
                                    String duration=jsn.getString("duration");
                                    ...
                                    BookingModel bookingModel=new BookingModel(bookingID,clientID,clientName,
                                            course,studyMode,fee,duration,startingDate,paymentMethod,paymentCode,bookingDate,
                                            phoneNo,bookingStatus);
