...
public class AdapterAsgnOrders extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//    }
    ...
    public AdapterAsgnOrders(Context context, List<AssignedModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.txv_orderID.setText("Order ID: "+o.getOrderID());
            ...
            view.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    in.putExtra("shippingCost",o.getDeliveryCost());
