...
import static com.example.Varsani.utils.Urls.URL_POST_ASSIGNMENT;
...
public class UploadAssignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        details_edt.setVisibility(View.GONE);
    ...
    private void uploadPDF(final String pdfname, Uri pdffile) {
        ...
        try {
            ...
            VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, URL_POST_ASSIGNMENT,
                    response -> {
...
//                                startActivity(in);
            ...
            rQueue = Volley.newRequestQueue(UploadAssignment.this);
