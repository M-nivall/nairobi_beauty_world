...
import static com.example.Varsani.utils.Urls.URL_ADD_NEW_STOCK;
...
public class CheckCompletedItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_completed_items);
        ...
        btn_add_stock = findViewById(R.id.btn_add_stock);
    ...
    public void add() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ADD_NEW_STOCK,
    ...
    public void getAlertAdd(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Add Stock");

        builder.setMessage("Add " + final_qty + " " + product + " to stock");
