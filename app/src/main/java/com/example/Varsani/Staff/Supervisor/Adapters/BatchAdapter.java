...
public class BatchAdapter extends RecyclerView.Adapter<BatchAdapter.BatchViewHolder> {
    ...
    public BatchAdapter(Context context, List<ProductionBatchModel> list) {
    ...
    public BatchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BatchViewHolder(LayoutInflater.from(context).inflate(R.layout.item_batch_card, parent, false));
    }
